...
public class BannerLayout extends RelativeLayout {
    ...
    public void setViewRes(List<Integer> viewRes) {
        ...
        if (itemCount < 1) {
            ...
            views.add(getLocalImageView(viewRes.get(0),0));
            views.add(getLocalImageView(viewRes.get(0),0));
            views.add(getLocalImageView(viewRes.get(0),0));

        } else if (itemCount < 3) {
            views.add(getLocalImageView(viewRes.get(0),0));
            views.add(getLocalImageView(viewRes.get(1),1));
            views.add(getLocalImageView(viewRes.get(0),0));
            views.add(getLocalImageView(viewRes.get(1),1));
        } else {
            for (int i = 0; i < viewRes.size(); i++) {
                views.add(getLocalImageView(viewRes.get(i),i));
            }
        }
        setViews(views);
    }
    ...
    @NonNull
    private ImageView getLocalImageView(Integer id,final int position) {
        ...
        imageLoader.displayImage1(getContext(),id,imageView1);
        return imageView1;
    }
    ...
    public interface ImageLoader extends Serializable {
        ...
        void displayImage1(Context context,Integer id,ImageView imageView);
    }
}
